...
$_SESSION['root'] = str_replace('\\', '/', realpath($currentDir.'/..'));

$http=(isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == 'on') ? 'https://' : 'http://';

$_SESSION['url']   = $http . $_SERVER['HTTP_HOST'].preg_replace('#/+#', '/', str_replace('\\', '/', dirname(dirname($_SERVER['SCRIPT_NAME']))).'/');
...
$_SESSION['baseurl'] =  $_SESSION['url']  .'public/';


//web service login & password
$_SESSION['wbservice']['username'] ='admin';
$_SESSION['wbservice']['password'] ='password';
